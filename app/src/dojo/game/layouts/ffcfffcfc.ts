// Source: contracts/src/layouts/ffcfffcfc.cairo
...
export class Configuration {
  public static starts(): Array<SpotType> {
    return [SpotType.Center, SpotType.North, SpotType.South, SpotType.West];
  }
  ...
  public static adjacentCities(from: SpotType): Array<SpotType> {
    switch (from) {
      ...
      case SpotType.SouthWest:
      case SpotType.West:
        return [SpotType.North, SpotType.South, SpotType.West];
      default:
        return [];
    }
  }
