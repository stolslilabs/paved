...
export const CharacterMenu = () => {
    ...
    return (
        <div id="character-menu" className="grid col-span-2 grid-cols-3 grid-rows-2 items-center justify-items-center col-start-1 row-start-8 sm:row-span-3 sm:col-span-2 sm:flex sm:flex-col sm:items-end sm:justify-center sm:gap-4">
