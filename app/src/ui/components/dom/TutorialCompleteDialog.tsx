...
import { AlertDialogHeader, AlertDialogFooter, AlertDialog, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogTitle } from "@/ui/elements/alert-dialog";
    ...
    return (game?.mode.value === ModeType.Tutorial) && (
        <AlertDialog open={step === maxSteps}>
            <AlertDialogContent className="bg-primary">
                ...
                <AlertDialogFooter>
                    <AlertDialogCancel onClick={handleClick} className="bg-secondary">Return to Lobby</AlertDialogCancel>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
