    ...
    <>
          ...
          <DrawerFooter>
            <div className="flex flex-col gap-2 px-8">
              <DrawerClose>
                ...
                >
                  <img src={surrenderIcon} className="absolute left-4 h-4" />
                  Surrender
                </Button>
              </DrawerClose>
              <div className="flex flex-col gap-2 py-2">
                ...
                <DrawerClose>
                  ...
                  >
                    <img src={homepageIcon} className="absolute left-4 h-4" />
                    Homepage
                  </Button>
                </DrawerClose>
                <SettingsDialog>
                  <Button variant="default" className="w-full">
                    <img src={settingsIcon} className="absolute left-4 h-4" />
                    Settings
                  </Button>
                </SettingsDialog>
              </div>
      ...
      <div className="flex flex-col absolute top-0 right-0 p-2 z-20 gap-1">
        ...
        <ToolTipButton
          ...
          icon={
            <img src={cancelIcon} className="h-8 sm:h-4 md:h-8 fill-current" />
          }
