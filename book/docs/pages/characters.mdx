...
Players have **7** characters (**5** in Puzzle mode). Each one can only be placed on specific structures. Each one also represents a certain number of allegience points, which (along with how many points it scores) may increase on some structures.
...
- can be placed on **forests** and **roads**
...
- can be placed on **forests** and **cities**
- scores a **multiplier** for each adjoining closed city that borders it

:::note
Note: **woodsman** & **herdsman** do not exist in **PUZZLE MODE**.
:::
