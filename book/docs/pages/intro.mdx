...
3. Explicit custom configs (feature-flagged).

All non-legacy creation requests are validated before dispatch and the effective config is snapshotted to the created game.
