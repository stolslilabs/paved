    ...
    impl WeeklyImpl of IWeekly<ContractState> {
        fn spawn(self: @ContractState) -> u32 {
            ...
            let (game_id, amount, team_amount, burn_amount) = self
                .hostable
                .spawn(self.world(@"paved").dispatcher, Mode::Weekly);
        ...
        fn claim(self: @ContractState, tournament_id: u64, rank: u8) {
            ...
            let reward = self
                .hostable
                .claim(self.world(@"paved").dispatcher, tournament_id, rank, Mode::Weekly);
        ...
        fn sponsor(self: @ContractState, amount: felt252) {
            ...
            let amount = self
                .hostable
                .sponsor(self.world(@"paved").dispatcher, amount, Mode::Weekly);
