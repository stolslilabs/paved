...
fn test_case_005() {
    ...
    let x = CENTER - 1;
    let y = CENTER - 1;
    systems.daily.build(world, context.game_id, orientation, x, y, Role::Adventurer, Spot::North);
    ...
    let x = CENTER + 1;
    let y = CENTER - 1;
    systems.daily.build(world, context.game_id, orientation, x, y, Role::Lord, Spot::Center);
