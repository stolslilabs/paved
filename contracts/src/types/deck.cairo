...
use paved::elements::decks::extended::Extended;
...
impl DeckImpl of DeckTrait {
    ...
    fn total_count(self: Deck) -> u8 {
        match self {
            ...
            Deck::Extended => Extended::total_count(),
        }
    }
    ...
    fn plan(self: Deck, index: u32) -> Plan {
        match self {
            ...
            Deck::Extended => Extended::plan(index),
        }
    }
    ...
    fn indexes(self: Deck, plan: Plan) -> Array<u8> {
        match self {
            ...
            Deck::Extended => Extended::indexes(plan),
        }
    }
    ...
    fn parameters(self: Deck, index: u32) -> (Orientation, u32, u32, Role, Spot) {
        match self {
            ...
            Deck::Extended => Extended::parameters(index),
        }
    }
