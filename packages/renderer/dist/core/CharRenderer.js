...
export class CharRenderer {
    ...
    createCharacter(char) {
        ...
        // Pedestal base (dark)
        const baseGeom = new THREE.CylinderGeometry(this.radius * BASE_RADIUS_FACTOR, this.radius * BASE_RADIUS_FACTOR, BASE_HEIGHT, SEGMENTS);
        ...
        const mainGeom = new THREE.CylinderGeometry(this.radius * MAIN_RADIUS_FACTOR, this.radius * MAIN_RADIUS_FACTOR, MAIN_HEIGHT, SEGMENTS);
        ...
        const innerGeom = new THREE.CylinderGeometry(this.radius * INNER_RADIUS_FACTOR, this.radius * INNER_RADIUS_FACTOR, INNER_HEIGHT, SEGMENTS);
        ...
        // Vertical rod
        const rodGeom = new THREE.CylinderGeometry(ROD_RADIUS, ROD_RADIUS, this.height * 2, SEGMENTS);
        ...
        const discGeom = new THREE.CylinderGeometry(this.radius * BASE_RADIUS_FACTOR, this.radius * BASE_RADIUS_FACTOR, BILLBOARD_HEIGHT, SEGMENTS);
        ...
        // Position in world
        charGroup.position.set(char.worldX * this.squareSize, 0, char.worldZ * this.squareSize);
        return charGroup;
    }
...
//# sourceMappingURL=CharRenderer.js.map