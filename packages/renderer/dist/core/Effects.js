...
export class Effects {
    ...
    init(renderer, scene, camera) {
        ...
        const bloomPass = new UnrealBloomPass(new THREE.Vector2(renderer.domElement.width, renderer.domElement.height), bloomConfig.strength ?? 0.5, bloomConfig.radius ?? 0.4, bloomConfig.threshold ?? 3);
