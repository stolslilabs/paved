...
export function defineContractComponents(world: World) {
  return {
	  ...
	  Character: (() => {
	    return defineComponent(
	      world,
	      { game_id: RecsType.Number, builder_id: RecsType.BigInt, index: RecsType.Number, tile_id: RecsType.Number, spot: RecsType.Number, weight: RecsType.Number, power: RecsType.Number },
	      {
	        metadata: {
	          name: "Character",
	  ...
	  Tile: (() => {
	    return defineComponent(
	      world,
	      { game_id: RecsType.Number, id: RecsType.Number, builder_id: RecsType.BigInt, plan: RecsType.Number, orientation: RecsType.Number, x: RecsType.Number, y: RecsType.Number, occupied_spot: RecsType.Number },
	      {
	        metadata: {
	          name: "Tile",
